...
function removeTicker(ticker) {
  tickerData.tickerList = tickerData.tickerList.filter((t) => t !== ticker);
  client.unsubscribe(ticker.name);
        ...
        <div class="flex">
          <div class="max-w-xs">
            ...
            <div class="mt-1 relative rounded-md shadow-md">
              <input
                id="wallet"
                v-model.trim="tickerData.ticker"
                type="text"
                name="wallet"
            ...
            <div
              v-if="tickerData.showTickerError"
      ...
      <template v-if="tickerData.tickerList.length > 0">
        ...
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
          <div
            ...
            @click="tickerData.selectedTicker = ticker"
          >
